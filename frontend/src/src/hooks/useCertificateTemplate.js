...
const DEFAULT_TEMPLATE = {
  ...
  leftSignatoryEnabled: false,
  leftSignatoryName: '',
  leftSignatoryDesignation: '',
  leftSignatoryCompany: '',
  leftSignatureImage: '',
  leftSignatureScale: 1,
  leftSignatureOffsetX: 0,
  leftSignatureOffsetY: 0,
  // Right Signatory (Optional)
  rightSignatoryEnabled: true,
    ...
    try {
      ...
      if (parsedTemplate) {
        setTemplate({
          ...
          // Left Signatory
          leftSignatoryEnabled: parsedTemplate.leftSignatoryEnabled ?? false,
          leftSignatoryName: parsedTemplate.leftSignatoryName ?? '',
          leftSignatoryDesignation: parsedTemplate.leftSignatoryDesignation ?? '',
          leftSignatoryCompany: parsedTemplate.leftSignatoryCompany ?? '',
          leftSignatureImage: parsedTemplate.leftSignatureImage || '',
          leftSignatureScale: typeof parsedTemplate.leftSignatureScale === 'number' ? parsedTemplate.leftSignatureScale : 1,
          leftSignatureOffsetX: typeof parsedTemplate.leftSignatureOffsetX === 'number' ? parsedTemplate.leftSignatureOffsetX : 0,
          leftSignatureOffsetY: typeof parsedTemplate.leftSignatureOffsetY === 'number' ? parsedTemplate.leftSignatureOffsetY : 0,
          // Right Signatory
          rightSignatoryEnabled: parsedTemplate.rightSignatoryEnabled ?? true,
